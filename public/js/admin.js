document.addEventListener("DOMContentLoaded", function () {
            ...
            if (addBtn) {
                addBtn.addEventListener("click", function () {
                    if (currentKey === "categorias") {
                        ...
                        if (window.Proceso && typeof window.Proceso.openCreateForm === "function") window.Proceso.openCreateForm();
                    } else if (currentKey === "departamentos") {
                        if (window.Departamento && typeof window.Departamento.openCreateForm === "function") window.Departamento.openCreateForm();
                    } else if (currentKey === "tareas") {
                        if (window.Tarea && typeof window.Tarea.openCreateForm === "function") window.Tarea.openCreateForm();
                    } else if (currentKey === "estados") {
                        if (window.Estado && typeof window.Estado.openCreateForm === "function") window.Estado.openCreateForm();
                    } else if (currentKey === "prioridades") {
                        if (window.Prioridad && typeof window.Prioridad.openCreateForm === "function") window.Prioridad.openCreateForm();
                    } else if (currentKey === "ans") {
                        if (window.ANS && typeof window.ANS.openCreateForm === "function") window.ANS.openCreateForm();
                    }
                });
    ...
    function setModalTitle() {
        ...
        if (addBtn) {
            var txt = currentKey === "categorias" ? "Añadir categoría" :
                      currentKey === "usuarios" ? "Añadir usuario" :
                      currentKey === "procesos" ? "Añadir proceso" :
                      currentKey === "departamentos" ? "Añadir departamento" :
                      currentKey === "tareas" ? "Añadir tarea" :
                      currentKey === "estados" ? "Añadir estado" :
                      currentKey === "prioridades" ? "Añadir prioridad" :
                      currentKey === "ans" ? "Añadir ANS" : "Añadir";
            addBtn.textContent = txt;
        }
    }
    function setHeaderForForm() {
        ...
        var formTitleMap = {
            ...
            prioridades: "Nueva prioridad",
            ans: "Nuevo ANS",
            procesos: "Nuevo proceso"
        };
        var formTitle = formTitleMap[currentKey] || "Nuevo elemento";
            ...
            if (editBtn) {
                ...
                if (id2) {
                    ...
                    if (currentKey === "categorias") {
                        ...
                        if (window.Proceso && typeof window.Proceso.openEditForm === "function") window.Proceso.openEditForm(nid);
                    } else if (currentKey === "departamentos") {
                        if (window.Departamento && typeof window.Departamento.openEditForm === "function") window.Departamento.openEditForm(nid);
                    } else if (currentKey === "tareas") {
                        if (window.Tarea && typeof window.Tarea.openEditForm === "function") window.Tarea.openEditForm(nid);
                    } else if (currentKey === "estados") {
                        if (window.Estado && typeof window.Estado.openEditForm === "function") window.Estado.openEditForm(nid);
                    } else if (currentKey === "prioridades") {
                        if (window.Prioridad && typeof window.Prioridad.openEditForm === "function") window.Prioridad.openEditForm(nid);
                    } else if (currentKey === "ans") {
                        if (window.ANS && typeof window.ANS.openEditForm === "function") window.ANS.openEditForm(nid);
                    }
                }
            }
        });
    ...
    window.AdminUI = {
        ...
        setHeaderForForm: setHeaderForForm,
        setHeaderForList: setHeaderForList,
        getBody: function () { return modal ? modal.querySelector(".admin-categories-body") : null; },
        refreshList: fetchAdminList,
        setCurrentKey: function (k) { currentKey = k; setModalTitle(); },
